# Requirements Archive: v1.6 Distribution Hardening
...
- [x] **DIST-06**: Repo provides a repeatable local verification path for the shipped non-notarized artifact, including the exact manual-open steps friends may need
- [x] **DIST-07**: Distribution hardening does not change the shipped WOL and keep-awake behavior beyond the release/share work needed for friend distribution
...
| DIST-06 | Phase 18 | Complete |
| DIST-07 | Phase 18 | Complete |
