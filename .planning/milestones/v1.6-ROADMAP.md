...
- 🚧 **v1.6 Distribution Hardening** — Phases 16-18 planned 2026-04-16; Phase 18 completed 2026-04-17 and the milestone is ready for closure
...
- [x] **Phase 18: Distribution Verification Closure** - Close the milestone with repeatable verification and regression proof for the non-notarized friend-share release flow. (completed 2026-04-17)
...
Plans:
- [x] `18-01-PLAN.md` — Add a mounted-DMG artifact check, one-shot verification command, and release docs aligned to the manual-open boundary.
**Success Criteria** (what must be TRUE):
...
| 18. Distribution Verification Closure | 1/1 | Complete | 2026-04-17 |
