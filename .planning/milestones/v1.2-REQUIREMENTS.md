# Requirements Archive: v1.2 Menu Truth

**Archived:** 2026-04-15
**Status:** SHIPPED

This archive captures the shipped v1.2 requirement set. The next milestone should define a fresh `.planning/REQUIREMENTS.md`.
...
Which phases cover which requirements. Final shipped ownership is preserved here.
