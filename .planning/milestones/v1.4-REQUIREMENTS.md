# Requirements Archive: v1.4 Duration UI Polish

**Archived:** 2026-04-16
**Status:** SHIPPED

This archive captures the shipped v1.4 requirement set. The next milestone should define a fresh `.planning/REQUIREMENTS.md`.
