...
**Plans**: 2 plans
Plans:
- [ ] 13-01-PLAN.md - Build the store-backed duration-management session model and CRUD validation contract.
- [ ] 13-02-PLAN.md - Add the native duration-management window, direct-launch coverage, and status-menu entry wiring.
**Success Criteria** (what must be TRUE):
...
| 13. Duration Management Surface | 0/2 | Planned | - |
