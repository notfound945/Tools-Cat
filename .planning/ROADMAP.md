...
- 🚧 **v1.4 Duration UI Polish** — Phase 14 planned
...
- [ ] **Phase 14: Duration Management UI Polish** - Refine the managed-duration list with native macOS list semantics and explicit edit/delete action styling.
...
|-------|----------------|--------|-----------|
| 14. Duration Management UI Polish | 0/0 | Not started | - |
