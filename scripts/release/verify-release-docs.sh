...
rg -q 'dist/export/Tools Cat\.app' README.md
! rg -q '构建 Release（二选一）' README.md
! rg -q '打包 DMG（不公证）' README.md
...
rg -q 'build/archive/Tools Cat\.xcarchive' docs/release/signing-readiness.md
rg -q 'dist/export/Tools Cat\.app' docs/release/signing-readiness.md
rg -q 'Phase 17' docs/release/signing-readiness.md

echo "[OK] Release documentation matches the Phase 16 signing contract"
